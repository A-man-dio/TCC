...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-A2SLZUZD.js").then((m) => m);
...
var routes = [
  {
    path: "login",
    loadComponent: () => import("./chunk-YPEZYZRW.js").then((m) => m.LoginComponent)
  },
  {
    path: "registar",
    loadComponent: () => import("./chunk-LTBFPRWZ.js").then((m) => m.RegisterComponent)
  },
  {
    path: "",
    loadComponent: () => import("./chunk-JE55MBVL.js").then((m) => m.ShellComponent),
