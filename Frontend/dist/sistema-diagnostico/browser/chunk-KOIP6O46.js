...
var TOKEN_KEY = "raiox_access_token";
var USER_KEY = "raiox_user";
var _AuthService = class _AuthService {
  ...
  login(req) {
    return this.http.post(`${this.baseUrl}/login`, req).pipe(tap((r) => this.saveSession(r)));
  }
  registar(req) {
    return this.http.post(`${this.baseUrl}/registar`, req).pipe(tap((r) => this.saveSession(r)));
  }
  logout() {
...
@angular/router/fesm2022/router.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-KOIP6O46.js.map
